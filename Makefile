...
# This Revision: $Id: Makefile,v 1.1 2009-01-24 19:04:26 raph Exp $
...
OBJECTS = usbdrv/usbdrv.o usbdrv/usbdrvasm.o usbdrv/oddebug.o main.o jaguar.o devdesc.o
...
# file targets:
main.bin:	$(COMMON_OBJS) jaguar.o devdesc.o 
